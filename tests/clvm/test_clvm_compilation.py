...
wallet_program_files = set(
    [
        "chialite/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "chialite/wallet/puzzles/cc.clvm",
        "chialite/wallet/puzzles/chialitelisp_deserialisation.clvm",
        "chialite/wallet/puzzles/rom_bootstrap_generator.clvm",
        "chialite/wallet/puzzles/generator_for_single_coin.clvm",
        "chialite/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "chialite/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "chialite/wallet/puzzles/lock.inner.puzzle.clvm",
        "chialite/wallet/puzzles/p2_conditions.clvm",
        "chialite/wallet/puzzles/p2_delegated_conditions.clvm",
        "chialite/wallet/puzzles/p2_delegated_puzzle.clvm",
        "chialite/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "chialite/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "chialite/wallet/puzzles/p2_puzzle_hash.clvm",
        "chialite/wallet/puzzles/rl_aggregation.clvm",
        "chialite/wallet/puzzles/rl.clvm",
        "chialite/wallet/puzzles/sha256tree_module.clvm",
        "chialite/wallet/puzzles/singleton_top_layer.clvm",
        "chialite/wallet/puzzles/did_innerpuz.clvm",
        "chialite/wallet/puzzles/decompress_puzzle.clvm",
        "chialite/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "chialite/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "chialite/wallet/puzzles/block_program_zero.clvm",
        "chialite/wallet/puzzles/test_generator_deserialize.clvm",
        "chialite/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["chialite/wallet/puzzles/create-lock-puzzlehash.clvm", "chialite/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "chialite/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to chialite/wallet/puzzles, but not added to `wallet_program_files`
        """
