...
from chialite.protocols.full_node_protocol import RespondBlock
from chialite.server.server import ChialiteServer
from chialite.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
from chialite.types.peer_info import PeerInfo
from chialite.util.ints import uint16, uint32, uint64
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSChialiteConnection] = wallet.server.get_outgoing_connections()
