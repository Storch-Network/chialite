...
- We have released version 1.0.0 of [chiapos](https://github.com/Chialite-Network/chiapos). This includes a 20% speed increase for bitfield plotting compared to the previous version on the same machine. In many cases this will mean that bitfield plotting is as fast or faster than non bitfield plotting.
...
- Changes were made to chiapos to correctly support the new bitfiled backpropogation on FreeBSD and OpenBSD. With the exception of needing to work around python cryptography as outlined on the wiki, FreeBSD and OpenBSD should be able to compile and run chialite-blockchain.
...
- We have bitfield optimized phase 2 of plotting. There is only about a 1% increase in speed from this change but there is a 12% decrease in writes with a penalty of 3% more reads. More details in [PR 120](https://github.com/Chialite-Network/chiapos/pull/120). Note that some sorts in phase 2 and phase 3 will now appear "out of order" and that is now expected behavior.
- Partial support for Python 3.9. That includes new versions of Chialite dependencies like chiabip158.
...
- Updated to chiapos 0.12.32. This update significantly speeds up the F1/first table plot generation. It also now can log disk usage while plotting and generate graphs. More details in the [chiapos release notes](https://github.com/Chialite-Network/chiapos/releases/tag/0.12.32).
...
- We added [lgtm](https://lgtm.com/) source analysis on pull request to the chialite-blockchain, chiapos, chiavdf, chiabip158, and bls-library repositories to add some automated security analysis to our ci.
...
- There was a regression in Chialite Proof of Space ([chiapos](https://github.com/Chialite-Network/chiapos)) that came from our efforts to speed up plotting on Windows native. Now k>=32 plots work correctly. We made additional bug fixes and corrected limiting small k size generation.
...
- The libraries chialite-pos, chialite-fast-vdf, and chialite-bip-158 have been moved to their own repositories: [chiapos](https://github.com/Chialite-Network/chiapos), [chiavdf](https://github.com/Chialite-Network/chiavdf), and [chaibip158](https://github.com/Chialite-Network/chiabip158). They are brought in by chialite-blockchain at install time. Our BLS signature library remains at [bls-signatures](https://github.com/Chialite-Network/bls-signatures).
