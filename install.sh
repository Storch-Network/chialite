...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Chialite Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Chialite-Network/chialite-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
python -m pip install --extra-index-url https://pypi.chialite.net/simple/ miniupnpc==2.1
python -m pip install -e . --extra-index-url https://pypi.chialite.net/simple/

echo ""
echo "Chialite blockchain install.sh complete."
echo "For assistance join us on Keybase in the #testnet chat channel:"
echo "https://keybase.io/team/chialite_network.public"
echo ""
echo "Try the Quick Start Guide to running chialite-blockchain:"
echo "https://github.com/Chialite-Network/chialite-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'chialite init' to begin."
