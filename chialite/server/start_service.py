...
from chialite.server.ssl_context import chialite_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"chialite_{service_name}"
        ...
        chialite_ca_crt, chialite_ca_key = chialite_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = ChialiteServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (chialite_ca_crt, chialite_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for ChialiteServer to be closed")
