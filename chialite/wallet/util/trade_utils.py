...
from chialite.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "chialite" in cc_discrepancies:
                    cc_discrepancies["chialite"] = cc_discrepancies["chialite"] + diff
                else:
                    cc_discrepancies["chialite"] = diff
