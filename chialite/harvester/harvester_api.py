...
from chialite.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from chialite.harvester.harvester import Harvester
from chialite.plotting.plot_tools import PlotInfo, parse_plot_info
from chialite.protocols import harvester_protocol
from chialite.protocols.farmer_protocol import FarmingInfo
from chialite.protocols.protocol_message_types import ProtocolMessageTypes
from chialite.server.outbound_message import make_msg
...
from chialite.util.api_decorators import api_request, peer_required
from chialite.util.ints import uint8, uint32, uint64
from chialite.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSChialiteConnection
    ):
        """
